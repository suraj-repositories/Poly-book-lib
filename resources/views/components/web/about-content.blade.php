<div class="container">
    ...
    <div class="row gy-4">
        <div class="col-lg-6 position-relative align-self-start" data-aos="fade-up" data-aos-delay="100">
            <img src="{{ $heroSection?->getAboutImageURL() ?? config('constants.default_about_image') }}" class="img-fluid" alt="about">
            <a href="{{ $heroSection->video_url ?? config('constants.default_video_url') }}" class="glightbox pulsating-play-btn"></a>
        </div>
