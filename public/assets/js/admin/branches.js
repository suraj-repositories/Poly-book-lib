...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Initialize Dropzone for the shared modal
...
// Function to open the modal and manage Dropzone content dynamically
function openEditBranchModal(element) {
    ...
    const imageUrl = element.getAttribute('data-branch-image'); // URL of the previously uploaded image
    ...
    // Set the branch name in the input
    updateModal.querySelector('#branchName').value = name;

    // Clear existing files in the Dropzone to prevent stacking
    ...
    if (imageUrl) {
        ...
        myDropzone.emit("thumbnail", mockFile, imageUrl); // Use the URL of the image
        myDropzone.emit("complete", mockFile);

        // Prevent removal of the mock file
